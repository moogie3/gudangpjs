...
if (isset($_POST['update'])) {
    ...
    $updatedata = mysqli_query($conn, "update pengeluaranalat set ida='$kodealat', nopo='$nopo', namapemesan='$namapemesan', namatoko='$namatoko', namabarang='$namabarang', qty='$qty', satuan='$satuan', harga='$harga' , lokasi='$lokasi', keterangan='$keterangan' where id='$id'");

    //cek apakah berhasil
    if ($updatedata) {

        echo " <div class='alert alert-success'>
        <strong>Sistem Berhasil Mengupdate Informasi PO</strong>
        </div>
        <meta http-equiv='refresh' content='1; url= pembelianbarang.php'/>  ";
    } else {
        echo "<div class='alert alert-warning'>
        <strong>Sistem Gagal Mengupdate Informasi PO</strong>
        </div>
        <meta http-equiv='refresh' content='1; url= pembelianbarang.php'/> ";
    }
}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-between align-items-center">
                        ...
                        <button data-toggle="modal" data-target="#myModal" class="btn btn-success col-md-2"><span class="glyphicon glyphicon-plus"></span>Tambah PO</button>
                    </div>
                    <div class="row">
                      <div class="col">
                        ...
                        while ($p = mysqli_fetch_array($palat)) {
                            ...
                            ?>
                                    <tr style="text-align: center">
                                       ...
                                       <td><br><button style="margin-bottom: 10px" data-toggle="modal" data-target="#edit<?= $id; ?>" class="btn btn-secondary">Edit PO</button>
                                           <br><button style="margin-bottom: 10px" data-toggle="modal" data-target="#del<?= $id; ?>" class="btn btn-danger">Delete PO</button></td>
                                       </tr>
                                               ...
                                               <div class="modal-content">
                                                   <form method="post">
                                                       ...
                                                       <div class="modal-header">
                                                           <h4 class="modal-title">Edit Nomor PO <?php echo $p['nopo'] ?> Barang <?php echo $p['namabarang'] ?></h4>
                                                       ...
                                                       <div class="modal-body">
                                                           ...
                                                           <input type="text" id="nopo" name="nopo" class="form-control" value="<?php echo $p['nopo'] ?>">

                                                           <label for="kodealat">Kode Alat</label>
                                                           <select name="kodealat" class="custom-select form-control">
                                                              <option selected value="<?php echo $p['idx'] ?>">Pilih Kode Alat</option>
                                                              <?php
                                                          ...
                                                          <input type="text" id="namapemesan" name="namapemesan" class="form-control" value="<?php echo $p['namapemesan'] ?>">

                                                          <label for="namatoko">Nama Toko</label>
                                                          <input type="text" id="namatoko" name="namatoko" class="form-control" value="<?php echo $p['namatoko'] ?>">

                                                          <label for="namabarang">Nama Barang</label>
                                                          <input type="text" id="namabarang" name="namabarang" class="form-control" value="<?php echo $p['namabarang'] ?>">

                                                          <label for="qty">Quantity</label>
                                                          <input type="text" id="qty" name="qty" class="form-control" value="<?php echo $p['qty'] ?>">

                                                          <label for="satuan">Satuan</label>
                                                          <select name="satuan" class="custom-select form-control">
                                                           <option selected value="<?php echo $p['satuan'] ?>">Pilih satuan</option>
                                       ...
                                       <div class="modal-dialog">
                                           <div class="modal-content">
                                               <form method="post">
                                                   <!-- Modal Header -->
                                                   <div class="modal-header">
                                                       <h4 class="modal-title">Hapus Barang dengan Nomor PO <?php echo $p['nopo'] ?> untuk Kode Alat <?php echo $p['kodealat'] ?></h4>
                                                       <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                   </div>
            ...
            <div class="modal-body">
                <form action="tmb_belibrg_act.php" method="post">
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input name="tanggal" type="datetime-local" class="form-control" placeholder="Tanggal PO" required>
                    </div>
                    <div class="form-group">
                        <label>No PO</label>
